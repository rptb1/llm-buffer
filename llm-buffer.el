...
;;;
;;; llm-buffer enables a conversation with an LLM that is derived from
;;; a single text file loaded into an Emacs buffer.  The buffer is
;;; processed into a prompt, the prompt is sent, and the reply from
;;; the LLM is streamed into the buffer.
;;;
...
;;; Copyright 2025 Richard Brooksby.
;;;
